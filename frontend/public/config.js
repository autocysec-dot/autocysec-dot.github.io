// Runtime configuration for the CRA tool frontend.
// This file is served as-is (not bundled), so you can change the backend URL
// WITHOUT rebuilding the app — just edit this value and redeploy.
//
